---
title: Zeta
description: Composable, fast, testable, OpenAPI-first backend framework with validation built-in.
template: index.html
---
...
- <span style="color: var(--color-base-content)">🧪</span> Easy to test
- <span style="color: var(--color-base-content)">📄</span> OpenAPI docs built-in
